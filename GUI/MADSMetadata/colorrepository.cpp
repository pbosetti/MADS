...
{
    return s_darkMode ? QColor(0x99, 0xff, 0x99) // almost black
                      : QColor(0xff, 0xff, 0xff); // almost white
}
...
{
    return QColor(0xdd, 0xff, 0xdd); // light gray
}
...
{
    return s_darkMode ? QColor(0x00, 0x17, 0x00) : QColor(0xf8, 0xf7, 0xf8);
}
...
{
    return s_darkMode ? QColor(0x00, 0x1f, 0x00, 0xa7) : QColor(0xf5, 0xf4, 0xf5) /* TODO with opacity = ? */;
}
