...
//
// Port range: 42700-42799 (see tests/mads_test_helpers.hpp).
...
TEST_CASE("bag roundtrip: publisher -> recorder -> file -> player -> "
  ...
  const uint16_t record_port = 42700;
  ...
  const uint16_t play_port = 42701;
...
TEST_CASE("bag roundtrip: --restamp (Mads::Play::try_restamp) rewrites "
          ...
          "[bag_roundtrip]") {
  mads_test::RunningGuard guard;
  const uint16_t record_port = 42710;
  ...
  const uint16_t play_port = 42711;
...
TEST_CASE("bag roundtrip: --topics ('sensors/+/x') replays only the "
  ...
  const uint16_t record_port = 42720;
  ...
  const uint16_t play_port = 42721;
...
TEST_CASE("bag roundtrip: --rate paces replay relative to the recorded "
  ...
  const uint16_t record_port = 42730;
  ...
  const uint16_t play_port = 42731;
