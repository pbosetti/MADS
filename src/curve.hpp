 ...
 * \param verbose whether to enable verbose logging
 */
void setup_auth(zmqpp::auth &authenticator, vector<string> const &ips,
 ...
 */
void setup_curve_server(zmqpp::auth &authenticator, zmqpp::socket &socket,
 ...
 * \param server_name the base name of the server public key file (.pub)
 */
void setup_curve_client(zmqpp::socket &socket, fs::path const &key_dir,
